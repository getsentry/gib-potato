        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <RouterLink
                                ...
                                class="rounded-md px-3 py-2 text-sm font-medium text-zinc-900"
                                :class="{
                                    'bg-zinc-900! text-zinc-50!': $route.path === '/collection',
                                }"
                            >
                                Collection
                            </RouterLink>
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex items-center">
                        <div class="relative ml-3">
                            ...
                            <div
                                v-show="menuOpen === true"
                                class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-zinc-50 dark:bg-zinc-800 py-1 shadow-lg ring-1 ring-zinc-900/5 focus:outline-hidden"
                            >
                                <RouterLink
                                    to="/profile"
                                    class="block px-4 py-2 text-sm"
                                    :class="{
                                        'bg-zinc-200 dark:bg-zinc-900': $route.path === '/profile',
                                    }"
                                >
                                    Your Profile
                                </RouterLink>
                                <RouterLink
                                    ...
                                    class="block px-4 py-2 text-sm"
                                    :class="{
                                        'bg-zinc-200 dark:bg-zinc-900': $route.path === '/settings',
                                    }"
                                >
                                    Settings
                                </RouterLink>
                ...
                <div class="-mr-2 flex sm:hidden">
                    <button
                        class="inline-flex items-center justify-center rounded-md p-2 text-zinc-900"
                        @click="menuOpen = !menuOpen"
                    >
                        <span v-show="menuOpen === false" class="block h-6 w-6"> 🍔 </span>
                        <svg
                            v-show="menuOpen === true"
                            class="block h-6 w-6"
