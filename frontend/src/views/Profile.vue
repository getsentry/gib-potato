<template>
    ...
    <div class="mt-2 mb-32">
        ...
        <div class="py-4">
            ...
            <p v-if="user.progression" class="mt-1 text-sm text-zinc-500">
                Your current potato level is
                <span
                    class="bg-purple-100 text-purple-800 text-sm font-medium ml-auto px-2.5 py-0.5 rounded-sm dark:bg-purple-900 dark:text-purple-300"
                >
        ...
        <div class="py-4">
            ...
            <ul class="divide-y divide-zinc-300">
                <li v-for="(message, index) in messages" :key="index" class="py-4">
