        ...
        <div>
            <div>
                ...
                <p class="mt-1 text-sm text-zinc-500">
                    Set your notification preferences when the <code>@GibPotato</code> Slack bot
                    should notify you.
                </p>
            </div>
            <ul role="list" class="mt-2 divide-y divide-zinc-200">
                ...
                <li class="flex items-center justify-between py-4">
                    <div class="flex flex-col">
                        ...
                        <p class="text-sm text-zinc-500" id="privacy-option-2-description">
                            Receive a notification at the end of your work day if you have any
                            leftover potato.
                        </p>
                    </div>
                    <button
                    ...
                    >
                        <span
                            class="translate-x-0 inline-block h-5 w-5 transform rounded-full bg-white shadow-sm ring-0 transition duration-200 ease-in-out"
                            :class="{
                                'translate-x-5!': user.notifications.too_good_to_go === true,
                            }"
                        >
                        </span>
                    </button>
